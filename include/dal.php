...
class tDAL
{
	var $tblreservation_at_localhost__bookings;
	var $tblreservation_at_localhost__halls;
	var $tblreservation_at_localhost__lookup_references;
	var $tblreservation_at_localhost__reservation_audit;
	var $tblreservation_at_localhost__reservationuggroups;
	var $tblreservation_at_localhost__reservationugmembers;
	var $tblreservation_at_localhost__reservationugrights;
	var $tblreservation_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "bookings", "varname" => "reservation_at_localhost__bookings", "altvarname" => "bookings", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "halls", "varname" => "reservation_at_localhost__halls", "altvarname" => "halls", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "lookup_references", "varname" => "reservation_at_localhost__lookup_references", "altvarname" => "lookup_references", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "reservation_audit", "varname" => "reservation_at_localhost__reservation_audit", "altvarname" => "reservation_audit", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "reservationuggroups", "varname" => "reservation_at_localhost__reservationuggroups", "altvarname" => "reservationuggroups", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "reservationugmembers", "varname" => "reservation_at_localhost__reservationugmembers", "altvarname" => "reservationugmembers", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "reservationugrights", "varname" => "reservation_at_localhost__reservationugrights", "altvarname" => "reservationugrights", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "reservation_at_localhost__users", "altvarname" => "users", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
	}
