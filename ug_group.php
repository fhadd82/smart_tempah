...
$nonAdminTablesArr[] = "bookings";
$nonAdminTablesArr[] = "halls";
$nonAdminTablesArr[] = "lookup_references";
...
$wGroupTableName = $ug_connection->addTableWrappers( "reservationuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "reservationugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "reservationugrights" );
