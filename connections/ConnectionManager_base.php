...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "reservation_at_localhost" );
	}
	...
	{
		return "reservation_at_localhost";
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["bookings"] = "reservation_at_localhost";
		$connectionsIds["halls"] = "reservation_at_localhost";
		$connectionsIds["lookup_references"] = "reservation_at_localhost";
		$connectionsIds["users"] = "reservation_at_localhost";
		$connectionsIds["admin_rights"] = "reservation_at_localhost";
		$connectionsIds["admin_members"] = "reservation_at_localhost";
		$connectionsIds["admin_users"] = "reservation_at_localhost";
