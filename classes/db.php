...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "reservation_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "bookings", "varname" => "reservation_at_localhost__bookings", "altvarname" => "bookings", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "halls", "varname" => "reservation_at_localhost__halls", "altvarname" => "halls", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "lookup_references", "varname" => "reservation_at_localhost__lookup_references", "altvarname" => "lookup_references", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "reservation_audit", "varname" => "reservation_at_localhost__reservation_audit", "altvarname" => "reservation_audit", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "reservationuggroups", "varname" => "reservation_at_localhost__reservationuggroups", "altvarname" => "reservationuggroups", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "reservationugmembers", "varname" => "reservation_at_localhost__reservationugmembers", "altvarname" => "reservationugmembers", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "reservationugrights", "varname" => "reservation_at_localhost__reservationugrights", "altvarname" => "reservationugrights", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "reservation_at_localhost__users", "altvarname" => "users", "connId" => "reservation_at_localhost", "schema" => "", "connName" => "reservation at localhost");
		}
	}
