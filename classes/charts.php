...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("bookings" == $this->chrt_array['tables'][0])
			return true;
		if("halls" == $this->chrt_array['tables'][0])
			return true;
		if("lookup_references" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("reservationugrights" == $this->chrt_array['tables'][0])
			return true;
		if("reservationugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		return false;
