...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "bookings" ] = array( "url" => "bookings", "type" => 0 );
	$projectEntitiesReverse[ "bookings" ] = "bookings";
	$projectEntities[ "halls" ] = array( "url" => "halls", "type" => 0 );
	$projectEntitiesReverse[ "halls" ] = "halls";
	$projectEntities[ "lookup_references" ] = array( "url" => "lookup_references", "type" => 0 );
	$projectEntitiesReverse[ "lookup_references" ] = "lookup_references";
